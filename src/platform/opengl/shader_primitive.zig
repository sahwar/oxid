...
pub const Shader = struct{
  ...
  pub fn bind(self: Shader, params: BindParams) void {
    ...
    if (self.uniform_color != -1) {
      // note: compile error is really crappy if you do this (should file an issue):
      // c.glUniform4fv(self.uniform_color, 4, c.ptr(params.color));
      c.glUniform4fv(self.uniform_color, 4, params.color[0..].ptr);
    }
